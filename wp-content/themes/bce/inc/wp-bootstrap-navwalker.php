...
/* Menu walker for main menu */ 


if ( ! class_exists( 'WP_Bootstrap_Main_Navwalker' ) ) {
	
	class WP_Bootstrap_Main_Navwalker extends Walker_Nav_Menu {
...
if ( ! class_exists( 'WP_Bootstrap_Costco_Navwalker' ) ) {
	
	class WP_Bootstrap_Costco_Navwalker extends Walker_Nav_Menu {
